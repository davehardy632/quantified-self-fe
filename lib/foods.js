class Foods{
  ...
  showSingleFood(singleFood){
    ...
    // let foodAddDropdown = this.createNode("button");
    // foodAddDropdown.className = "btn btn-primary dropdown-toggle"
    // foodAddDropdown.type = "button"
    // foodAddDropdown.setAttribute("data-toggle", "dropdown");
    // foodAddDropdown.innerHTML = "Add Food To Meal"
    // let foods = ["banana", "mango", "chicken"]
    ...
    //   foodItem.addEventListener("click",  () => {console.log("test")}, true);
    //   dropDownMenu.appendChild(foodItem)
    // })
    // dropDown.appendChild(foodAddDropdown);
